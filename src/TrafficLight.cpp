...
T MessageQueue<T>::receive(void)
{
    ...
    _cond.wait(mtx,[this](){return(!_messages.empty());});
...
void MessageQueue<T>::send(T &&msg)
{
    ...
    // as well as _condition.notify_one() to add a new message to the queue and afterwards send 
    //a notification.
